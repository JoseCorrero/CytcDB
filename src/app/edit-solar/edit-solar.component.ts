...
@Component({
  selector: 'app-edit-solar',
  templateUrl: './edit-solar.component.html',
  styleUrls: ['./edit-solar.component.css']
})
export class EditSolarComponent implements OnInit {
  ...
  update() {
    ...
    this.instServ.updateInstalacion(
      ...
      this.router.navigate(['/detalles-solar/', this.idInstalacion]);
    });
  }
}